...
#define SECONDS_PER_PALETTE  600
...
{  CRGB::White, CRGB::White, CRGB::White, CRGB::White, 
   CRGB::Red, CRGB::Red, CRGB::Red, CRGB::Red,
   CRGB::Green, CRGB::Green, CRGB::Green, CRGB::Green, 
   CRGB::White, CRGB::Red, CRGB::Green, CRGB::Green
};

const TProgmemRGBPalette16 Sakura_p FL_PROGMEM =
{  CRGB::Purple, CRGB::Purple, CRGB::Purple, CRGB::Purple, 
   CRGB::Purple, CRGB::Purple, CRGB::Purple, CRGB::Purple,
   CRGB::Purple, CRGB::Purple, CRGB::Purple, CRGB::Purple, 
   CRGB::Purple, CRGB::Pink, CRGB::Purple, CRGB::Purple
};

const TProgmemRGBPalette16 Autumn_p FL_PROGMEM =
{  CRGB::Orange, CRGB::Orange, CRGB::Red, CRGB::Yellow, 
   CRGB::Orange, CRGB::Orange, CRGB::Red, CRGB::Yellow, 
   CRGB::Orange, CRGB::Orange, CRGB::Red, CRGB::Yellow, 
   CRGB::Orange, CRGB::Orange, CRGB::Red, CRGB::Yellow
};
...
void chooseColorPalette( const TProgmemRGBPalette16& pal)
{
   gTargetPalette = pal;
}

void setup_TinkleFox() {
